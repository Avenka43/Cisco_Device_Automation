...
def args():
    parser = argparse.ArgumentParser(description='Program to search through switches '
                                                 'and auto configure ports based on CDP.')
